...
def handle_telegram_commands():
    """
    Baca command Telegram. last_update_id disimpan ke file
    (di-cache via GitHub Actions) sehingga command lama tidak
    di-replay setiap kali workflow dijalankan ulang.
    """
    ...
    try:
        ...
        if last_id is not None:
            params["offset"] = last_id + 1  # skip semua update yang sudah diproses
        ...
        for upd in data["result"]:
            ...
            # Simpan dulu sebelum proses — aman meski crash di tengah
